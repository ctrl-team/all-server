...
window.onload = async function() {
  ...
  const sounds = [
    "/spookygame/img/whereareyou.mp3",
    "/spookygame/img/hideseek.mp3",
    "/spookygame/img/iseeyou.mp3"
  ];

  const popsound =
    "/spookygame/img/pop.wav";

  const candyimg = [
    "/spookygame/img/cukierek.png",
    "/spookygame/img/lizak.png",
    "/spookygame/img/krowka.png",
    "/spookygame/img/cukierek2.png"
  ];

  const vegeimg = [
    "/spookygame/img/pomidor.png",
    "/spookygame/img/marchewka.png",
    "/spookygame/img/salatka.png",
    "/spookygame/img/oguras.png"
  ];
